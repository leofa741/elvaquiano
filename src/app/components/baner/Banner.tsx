// app/components/baner/Banner.tsx
'use client';
...
export default function DistribuidoraBanner() {
  return (
    <div className="relative w-full min-h-[500px] sm:min-h-[600px] bg-red-800 overflow-hidden flex items-center justify-center py-10">
      {/* Imagen de fondo: productos alimenticios en almacén o camión de reparto */}
      <Image
        src="/img/El-Vaquiano.svg" // ← Reemplazar con foto real de alta calidad
        width={1920}
        height={800}
      ...
      {/* Overlay rojo oscuro para contraste de texto */}
      ...
      <div className="relative z-10 flex flex-col justify-center items-center text-white px-4 text-center max-w-4xl mx-auto">
        ...
        <Image
          src="/El-Vaquiano.png" // Asegúrate de que este logo tenga fondo transparente
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 leading-tight">
          Abastecé tu negocio con los <span className="text-amber-400">mejores precios mayoristas</span>
        </h1>
        ...
        {/* Valores rápidos (sin íconos decorativos, solo funcionales) */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full max-w-3xl">
          <div className="flex flex-col items-center">
            <FaTruckFast className="text-2xl mb-1 text-amber-300" />
            <span className="text-xs sm:text-sm">Entrega 24-48h</span>
          </div>
          <div className="flex flex-col items-center">
            <FaBox className="text-2xl mb-1 text-amber-300" />
            <span className="text-xs sm:text-sm">Stock Garantizado</span>
          </div>
          <div className="flex flex-col items-center">
            <FaHandsHolding className="text-2xl mb-1 text-amber-300" />
            <span className="text-xs sm:text-sm">Atención Humana</span>
          </div>
          <div className="flex flex-col items-center">
            <FaPhone className="text-2xl mb-1 text-amber-300" />
