...
export default function StockValueSummary() {
    ...
    // En tu caso, "totalMayorista" es el valor de venta (más alto),
    // y "totalLista" es la inversión (más bajo).
    const valorVenta = totales.totalMayorista;   // Esto es tu "facturación potencial"
    const inversion = totales.totalLista;        // Esto es tu "capital comprometido"
    ...
    return (
        <div className="bg-gray-800 p-4 rounded-lg mb-6 border border-gray-700">
            ...
            {/* Barra visual: inversión + ganancia */}
            <div className="mt-2">
